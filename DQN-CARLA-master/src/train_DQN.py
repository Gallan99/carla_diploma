...
if __name__ == '__main__':
    ...
    file1 = open('episodes_info/avg_reward_list', 'w')
    file2 = open('episodes_info/min_reward_list', 'w')
    file3 = open('episodes_info/max_reward_list', 'w')
    file4 = open('episodes_info/average_dist_list', 'w')
    file5 = open('episodes_info/episodes', 'w')
